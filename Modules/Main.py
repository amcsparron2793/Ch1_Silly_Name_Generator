...
# main func
def main_func():
    """Choose names at random from 2 tuples of names and print the choices to the screen."""
    ...
    while True:
        ...
        try_again = input("\nTry again? (Press Enter to try again, or press n to quit)\n")
